...
describe('EntityId', () => {
  describe('create', () => {
    it('should create a new EntityId from valid UUID string', () => {
  ...
  describe('toJSON', () => {
    it('should return the id as JSON string', () => {
      const uuid = '123e4567-e89b-12d3-a456-426614174000';
